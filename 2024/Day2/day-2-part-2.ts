// Day 2 Part 2 Challenge 

console.log("===============");
console.log("Day 2 Challenge Part 2");
console.log("===============");
//report 176
function findReportSafeCount(arr) {
    let count = 0;
    for (let i = 0; i < arr.length; i++) {
        let isNotSafe = 0;
        let isIncreasing = false;
        let isDecreasing = false;
        let numberOfNotSafes = 0;
        const numbers = arr[i].split(' ').map(Number);
        numbers.forEach((num, index) => {
            if (index !== numbers.length) {
                if (num == numbers[index + 1]) {
                    if (index !== numbers.length - 1 && ((num == numbers[index + 2]) || (Math.abs(num - numbers[index + 2]) < 1) || (Math.abs(num - numbers[index + 2]) > 3))) {
                        isNotSafe += 1;
                        console.log(`Report ${i + 1} is Not safe at index ${index} with number ${num} and next number ${numbers[index + 1]}`);
                    } else {
                        numberOfNotSafes += 1;
                    }
                } else if ((Math.abs(num - numbers[index + 1]) < 1) || (Math.abs(num - numbers[index + 1]) > 3)) {
                    if (index !== numbers.length - 1 && (Math.abs(num - numbers[index + 2]) < 1) || (Math.abs(num - numbers[index + 2]) > 3)) {
                        isNotSafe += 1;
                        console.log(`Report ${i + 1} is Not safe at index ${index} with number ${num} and next number ${numbers[index + 1]}`);
                    } else {
                        numberOfNotSafes += 1;
                    ...
                    let currentDir = 0; // 0 = not set, 1 = increasing, -1 = decreasing
                    if (num > numbers[index + 1]) {
                        isDecreasing = true;
                        currentDir = -1;
                    }
                    ...
                    if (isIncreasing && isDecreasing) {
                        if ((index !== numbers.length && index !== 0) && ((currentDir == -1 && numbers[index - 1] > numbers[index + 1]) || (currentDir == 1 && numbers[index - 1] < numbers[index + 1]))) {
                            isNotSafe += 1;
                            console.log(`Report ${i + 1} is Not safe at index ${index} with number ${num} and next number ${numbers[index + 1]}`);
                        } else {
                            if (currentDir == -1) {
        ...
        if (isNotSafe < 1 && numberOfNotSafes < 2) {
            // console.log(`Report ${i + 1} is safe`, numbers);
            count++;
        } else {
            console.log(`Report ${i + 1} is NOT safe`, numbers);
        }
    }
    return count;
}
...
// var input = ['22 25 27 28 30 31 32 29',
...
console.log("Safe Report Count: " + findReportSafeCount(input));